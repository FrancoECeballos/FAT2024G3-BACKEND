    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fechavencimiento', models.DateField(blank=True, db_column='fechaVencimiento', null=True)),
                ('cantidad', models.IntegerField(blank=True, null=True)),
                ('urgente', models.IntegerField(blank=True, choices=[(1, 'No es urgente'), (2, 'Urgente'), (3, 'Inmediato')], null=True)),
            ],
            options={
                'db_table': 'Pedido',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre', models.CharField(blank=True, max_length=255, null=True)),
                ('descripcion', models.CharField(blank=True, max_length=255, null=True)),
                ('unidadmedida', models.IntegerField(blank=True, choices=[(0, 'Unidad/es'), (1, 'Kilogramo/s'), (2, 'Litro/s'), (3, 'Metro/s')], db_column='unidadMedida', default=0, null=True)),
                ...
                ('sin_tac', models.IntegerField(blank=True, db_column='sin_TAC', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descripcion_mantenimiento', models.CharField(blank=True, default='', max_length=1000, null=True)),
            ],
            options={
                'db_table': 'Transporte',
                'managed': False,
