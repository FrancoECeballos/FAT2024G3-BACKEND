...
urlpatterns = [
    ...
    path('crear_aporte_pedido/', CrearAportePedido.as_view(), name='crear_detalle_pedido'),
    path('editar_aporte_pedido/<int:pk>/', EditarAportePedido.as_view(), name='editar_detalle_pedido'),
    ...
    path('editar_detalle_pedido/<int:pk>/', DeleteDetalleobrapedido.as_view(), name='editar_detalle_pedido'),
