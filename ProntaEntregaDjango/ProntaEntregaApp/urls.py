...
urlpatterns = [
    ...
    path('PostNotificacionForObra/<int:id_obra>/', PostNotificacionForObra.as_view(), name='PostNotificacionForObra'),
    path('PostNotificacionForUser/<int:id_usuario>/', PostNotificacionForUser.as_view(), name='PostNotificacionForUser'),
    ...
    path('EndPedido/<int:pk>/', EndPedido.as_view(), name='EndPedido'),
    ...
    path('GetOfertaCreadaPorUsuario/<str:pk>/', GetOfertaCreadaPorUsuario.as_view(), name='GetOfertaCreadaPorUsuario'),
    ...
    path('editar_entrega_aporte/<int:pk>/', EditarEntregaAporte.as_view(), name='editar_entrega'),
    path('editar_entrega_aporte_estado/<int:pk>/<int:new_estado>/', EditarEntregaAporteEstado.as_view(), name='editar_entrega_estado'),
